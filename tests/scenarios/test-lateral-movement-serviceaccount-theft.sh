...
# Test: Lateral Movement - ServiceAccount Token Theft
set -e

TEST_NAME="lateral-movement-serviceaccount-theft"
NAMESPACE="test-${TEST_NAME}"
ATTACK_FILE="attacks/lateral-movement/serviceaccount-theft.yaml"
